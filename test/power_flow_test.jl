...
power_grid= @network begin
    ...
    SM1 = synchronousmachine(P = 50, Q=0, V = 0.99 * 220/sqrt(3))
    ...
    TLC1[1.1]== CableDC12[2.1] ⟷ NodeDC1

    TF1[1.1] ⟷ TLC1[2.1] #⟷ # NodeMMC1d
    TF1[1.2] ⟷ TLC1[2.2] ⟷ NodeMMC1q
...
new_data_dict = data
original_data = jldopen("data/pf_dict_advanced.jld")["pf_dict"]
original_results = jldopen("data/results_advanced.jld")["results"]
@test original_data == new_data_dict
@test original_results ≈ new_result atol=1e-8
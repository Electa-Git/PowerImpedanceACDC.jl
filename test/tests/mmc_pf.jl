...
@time net = @network begin
    ...
    c1 = mmc(Vᵈᶜ = 640, Vₘ = 230,
            P_max = -50, P_min = -1500, P = -150, Q = 0, Q_max = 500, Q_min = -500, P_dc = 100,
    ...
    c2 = mmc(Vᵈᶜ = 640, Vₘ = 230,
            P_max = 1500, P_min = 50, P = 150, Q = 0, Q_max = 300, Q_min = -300, P_dc = -100,
            occ = PI_control(ζ = 0.7, bandwidth = 1000),
            ccc = PI_control(ζ = 0.7, bandwidth = 300),
...
@time imp, omega = check_stability(net, net.elements[:c1], direction = :dc, omega_range = (0,4,100))

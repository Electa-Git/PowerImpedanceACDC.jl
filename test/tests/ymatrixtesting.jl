...
# Y_matrix_AC = HVDCstability.make_y_matrix(net,input_pins = Any[:Node1A,:Node1B,:Node1C,:Node2A,:Node2B,:Node2C,:Node3A,:Node3B,:Node3C], omega_range = (-3, 4, 1000))
# Y_matrix_AC = HVDCstability.make_y_matrix(net,input_pins = Any[:Node1A,:Node2A,:Node3A], omega_range = (-3, 4, 1000))
Y_matrix_AC = HVDCstability.make_y_matrix(net,input_pins = Any[:Node1D,:Node1Q,:Node2D,:Node2Q,:Node3D,:Node3Q], omega_range = (-3, 4, 1000))

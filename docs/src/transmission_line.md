...
$\mathbf{Y}_c = \mathbf{Z}^{-1} \, \Gamma$, and $l$ standing for the line or cable length. The used formula is based on the frequency-dependent phase domain model.
...
![PSCAD overhead line organization](pictures/transmission_line/tl.png)
...
![Validation of overhead power line](pictures/transmission_line/transmission_line_example1.png)

...
@time net = @network begin
        ...
        c1 = mmc(Vᵈᶜ = 800, vDCbase = 800, vACbase_LL_RMS = 380, turnsRatio = 380/380, Vₘ = transmissionVoltage, Lᵣ = 60e-3, Rᵣ = 0.535,
                P_max = 1500, P_min = -1500, P = -pHVDC1, Q = qC1, Q_max = 500, Q_min = -500,
        ...
        # # PU gains
        c3 = mmc(Vᵈᶜ = 800, vDCbase = 800, vACbase_LL_RMS = 380, turnsRatio = 380/380, Vₘ = transmissionVoltage, Lᵣ = 60e-3, Rᵣ = 0.535,
                P_max = 1500, P_min = -1500, P = -pHVDC2, Q = qC3, Q_max = 500, Q_min = -500,
                occ = PI_control(Kₚ = 0.7691, Kᵢ = 522.7654),
                ccc = PI_control(Kₚ = 0.1048, Kᵢ = 48.1914),
                pll = PI_control(Kₚ = 0.28, Kᵢ = 12.5664),

...
net = @network begin
    ...
    MMC3 = mmc(Vᵈᶜ = Vdc, vDCbase = 800, vACbase_LL_RMS = 380, vPCC_scaling = 380/380, Vₘ = Vm, Lᵣ = 60e-3, Rᵣ = 0.535,
    ...
    #G2[1.1] ⟷ Zg2[1.1]
    #G2[1.2] ⟷ Zg2[1.2]
    #Zg2[2.1] ⟷ CableAC2g2[2.1] ⟷ NodeDg2
    #Zg2[2.2] ⟷ CableAC2g2[2.2] ⟷ NodeQg2
...
# AC-side
Z_MMC_AC1, omega = determine_impedance(net, elim_elements = [:OHLAC1g1], input_pins = Any[:NodeD1, :NodeQ1], output_pins = Any[:gndD, :gndQ], omega_range = (-3, 4, 1000))
Z_BUS_AC1, omega = determine_impedance(net, elim_elements = [:MMC1], input_pins = Any[:NodeD1, :NodeQ1], output_pins = Any[:gndD, :gndQ], omega_range = (-3, 4, 1000))
L_AC1 = Z_BUS_AC1 ./ Z_MMC_AC1

nyquist_L_AC1 = nyquistplot(L_AC1, omega, zoom = "no", SM = "VM") 
=#
...
#MMC1_data = net.elements[:MMC1]
#plot_data(MMC1_data, omega_range = (0, 3, 1000), scale = :log)
